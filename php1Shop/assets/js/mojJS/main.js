$(document).ready(function () {
    ...
    $("btnRegister").click(proveraregistrovanja);
...
//Dohvatanje Top Proizvoda
function getTopProducts(){
    $.ajax({
        url:"logic/getTopProducts.php",
        method:"get",
        dataType:"json",
        success:function(data){
            writeProducts(data);
    ...
    for (const product of data) {
        ...
        <div class="single-popular-items mb-50 text-center">
            <div class="popular-img">
                ...
                <div class="img-cap">
                    <span class="btnAddToCart" data-id=${product.id}>Add to cart</span>
                </div>
            </div>
...
function getPaymentOffers(){
    $.ajax({
        url:"logic/getPaymentOffers.php",
        method:"get",
        dataType:"json",
        success:function(data){
...
function getGalleryImages(){
    $.ajax({
        url:"logic/getGalleryImages.php",
        method:"get",
        dataType:"json",
        success:function(data){
...
function parniIspis(item){
    ...
    <div class="col-lg-5 col-md-6">
        <div class="watch-details mb-40">
            <h2>${item.title}</h2>
            <p>${item.description}</p>
            <a href="index.php?page=2" class="btn">Show Watches</a>
        </div>
    </div>
...
function proveraregistrovanja(){
    ...
    if(password.value != repassword.value || repassword.value == ""){
            ...
            $("#testPasswordError").addClass("formaError");
    } else {
        $("#testPasswordError").addClass("invisible");
        $("#testPasswordError").removeClass("formaError");
        $("#testpassword").addClass("formaSuccess");
    }
    if(otpadak.length==0){
...
function deleteRecord(tableName,id){
    ...
    if(r){
        $.ajax({
            url:"logic/delete"+ tableName +".php",
            method:"POST",
            dataType:"json",
            data:{
                "delete": true,
...
function tabelaIspis(data, tableName){
    ...
    for (const item of data) {
        ...
        output += `<td><a class="bojaIkonica"><i class="fas fa-edit"></i></a></td>
        <td><a class="bojaIkonica" onclick="deleteRecord('${tableName}', ${item.id})"><i class="fas fa-trash-alt"></i></a></td>
        </tr>`;
    }
...
function formAddProduct(){
    $.ajax({
        url:"logic/getBrandsAndGenders.php",
        method:"get",
        dataType:"json",
        success:function(data){
...
function addNewProduct(){
    ...
    $.ajax({
        url:"logic/insertNewProduct.php",
        method:"post",
        dataType:"json",
        processData:false,
        contentType:false,
...
function addNewMenu(){
    ...
    $.ajax({
        url:"logic/insertNewMenuItem.php",
        method:"post",
        dataType:"json",
        processData:false,
        contentType:false,
